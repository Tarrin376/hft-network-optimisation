...
HFTTypes::Graph::Graph(std::size_t num_nodes, std::size_t num_edges) 
    : m_nodes(num_nodes)
    , m_edges(num_edges)
...
void HFTTypes::Graph::add_edge(const Edge& edge, bool source_is_server) {
...
std::size_t HFTTypes::Graph::get_num_edges() const {
    return m_num_edges;
}